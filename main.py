...
# Текст — быстрый и бесплатный Llama 3.3 70B на LPU-железе Groq:
GROQ_TEXT_MODEL = "llama-3.3-70b-versatile"
# Фото — Llama 4 Scout, тоже бесплатно на Groq, умеет vision:
GROQ_VISION_MODEL = "meta-llama/llama-4-scout-17b-16e-instruct"
# Видео Groq не понимает вообще ни в каком тарифе — для видео нужен
